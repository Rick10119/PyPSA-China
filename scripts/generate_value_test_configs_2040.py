...
def main():
    ...
    print()
    print("使用方法:")
    print("1. 运行单个配置: ./sh_scripts/run_LMM_2040_100p.sh")
    print("2. 运行所有配置: ./sh_scripts/run_all_configs.sh")
    print("3. 手动运行: snakemake --configfile configs/config_LMM_2040_100p.yaml --cores 40")
    print("4. 提交SLURM作业: sbatch jobs/job_LMM_2040_100p.slurm")
