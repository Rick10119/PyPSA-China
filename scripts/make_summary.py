...
def calculate_aluminum_statistics(n, label, aluminum_statistics):
    ...
    # Find aluminum smelter links (exclude China hub connections)
    all_aluminum_links = n.links.index[n.links.carrier == "aluminum"]
    ...
    if len(aluminum_smelters) == 0:
        logger.warning("No aluminum smelters found in the network (excluding China hub connections)")
        # Set default values
        for stat in stats_list:
            aluminum_statistics.at[stat, label] = 0.0
        return aluminum_statistics
