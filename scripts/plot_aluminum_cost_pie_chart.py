...
def create_aluminum_cost_pie_chart():
    ...
    costs_2050_5p = [8451.2, 159.889114, 2171.893745, 769.1493874, 1156.812339, 1, 3963.454993]
    ...
    # 2050_5p饼状图
    wedges2, texts2, autotexts2 = ax2.pie(costs_2050_5p, labels=categories, colors=colors, 
                                         autopct='%1.1f%%', startangle=90, textprops={'fontsize': 9})
    ax2.set_title('2050_5p Aluminum Cost Composition\n(Total Cost: {:.0f} CNY/ton)'.format(total_2050_5p), 
                  fontsize=12, fontweight='bold', pad=15)
    ...
    # 添加总标题
    fig.suptitle('Aluminum Cost Composition Comparison (2020 vs 2050 Scenarios)', fontsize=16, fontweight='bold', y=0.95)
