#!/bin/bash
# Non-flexible场景的模拟 (Flexibility: mid, Demand: mid, Market: high, Year: 2040)
...
snakemake --configfile configs/config_MMH_2040_non_flexible.yaml --cores 40

echo "完成 MMH_2040_non_flexible 的模拟"
