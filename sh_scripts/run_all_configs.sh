...
echo "Flexibility: mid (中等), Demand: mid (中等), Market: low, Year: 2050"
...
echo "Flexibility: mid (中等), Demand: mid (中等), Market: mid, Year: 2050"
echo "注意：此配置适用于所有non-flexible情景，因为不同的flex和demand会产生相同的结果"
echo
...
echo "Flexibility: mid (中等), Demand: mid (中等), Market: high, Year: 2050"
echo "注意：此配置适用于所有non-flexible情景，因为不同的flex和demand会产生相同的结果"
echo
